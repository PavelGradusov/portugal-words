...
const irregularVerbs: VerbType[] = [
  {
    ...
    translationRu: "быть (постоянное состояние)",
    verbForms: {
      i: "sou",
      you: "és",
      heSheIt: "é",
  ...
  },
  {
    ...
    translationRu: "быть (временное состояние)",
    verbForms: {
      i: "estou",
      you: "estás",
      heSheIt: "está",
  ...
  },
  {
    ...
    translationRu: "делать / создавать",
    verbForms: {
      i: "faço",
      you: "fazes",
      heSheIt: "faz",
  ...
  },
  {
    ...
    translationRu: "говорить / рассказывать",
    verbForms: {
      i: "digo",
      you: "dizes",
      heSheIt: "diz",
  ...
  },
  {
    ...
    translationRu: "просить / запрашивать",
    verbForms: {
      i: "peço",
      you: "pedes",
      heSheIt: "pede",
  ...
  },
  {
    ...
    translationRu: "выходить / уходить",
    verbForms: {
      i: "saio",
      you: "sais",
      heSheIt: "sai",
  ...
  },
  {
    ...
    translationRu: "подниматься / взбираться",
    verbForms: {
      i: "subo",
      you: "sobes",
      heSheIt: "sobe",
  ...
  },
  {
    ...
    verb: "caber",
    translation: "to fit",
    translationRu: "вмещаться / подходить по размеру",
    verbForms: {
      i: "caibo",
      you: "cabes",
      heSheIt: "cabe",
